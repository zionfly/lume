              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {skill.auto_generated && (
                    <span className="text-[10px] bg-lume-400/10 text-lume-400 px-1.5 py-0.5 rounded">
                      auto
                    </span>
                  )}
                </div>
        ...
        {selectedSkill && (
          <div className="border-t border-surface-3 p-4">
            <div className="flex justify-between items-center mb-2">
              <h4 className="text-sm font-medium">{selectedSkill}</h4>
              <button
            ...
            <pre className="text-xs text-gray-300 whitespace-pre-wrap font-mono bg-surface-2 rounded-lg p-3 max-h-64 overflow-y-auto">
              {skillContent}
            </pre>
          </div>
        )}
