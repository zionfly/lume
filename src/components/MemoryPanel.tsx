  ...
  return (
    <div className="w-80 bg-surface-1 border-l border-surface-3 flex flex-col">
      <div className="p-4 border-b border-surface-3">
        <h3 className="font-semibold text-sm text-sand-900">Memory System</h3>
        <p className="text-xs text-sand-400 mt-1">3-layer architecture</p>
      </div>
          ...
          <div>
            <div className="flex gap-2 mb-3">
              <input
                ...
                className="flex-1 bg-white border border-surface-3 rounded-lg px-3 py-1.5 text-xs outline-none focus:ring-1 focus:ring-lume-400/50"
              />
            </div>
            <div className="space-y-2">
              {searchResults.map((r, i) => (
                <div key={i} className="bg-white shadow-sm rounded-lg p-2">
                  <p className="text-xs text-sand-700 line-clamp-3">
                    {r.content}
                  </p>
